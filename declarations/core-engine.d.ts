...
declare class BlockSource {
	...
	* @param x X coord of the position
	 ...
	 * and all except the entities of the given type, if blacklist value is true
	 */
	listEntitiesInAABB(x1: number, y1: number, z1: number, x2: number, y2: number, z2: number, type: number, blacklist: boolean): java.util.List<number>;
...
declare namespace Callback {
    ...
    function addCallback(name: "GenerateCustomDimensionChunk", func: {(chunkX: number, chunkZ: number, random: java.util.Random, dimensionId: number): void}): void;

    function addCallback(name: "CustomDimensionTransfer", func: {(entity: number, from: number, to: number): void}): void;
     ...
     * @param player player that ate the food
     */
...
declare namespace NBT {
    ...
    class CompoundTag {
         ...
         */
        putCompoundTag(key: string, value: NBT.CompoundTag): void;

        /**
         * Puts value of list type into compound tag
         */
        putListTag(key: string, value: NBT.ListTag): void;
    ...
    class ListTag {
         ...
         */
        putCompoundTag(index: number, value: NBT.CompoundTag): void;

        /**
         * Puts value of list type into list tag
         */
        putListTag(index: number, value: NBT.ListTag): void;
...
declare namespace TileEntity {
     ...
     * behavior
     */
    function registerPrototype(blockID: number, customPrototype: TileEntity): void;
